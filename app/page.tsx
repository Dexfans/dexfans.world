...
import { Heart, MessageCircle, Send, Bookmark, Plus, Search, Home, Compass, User, Video } from "lucide-react";
...
const posts = [
  {
    ...
    likes: "18,421",
    caption: "Welcome to my world ✨ New content dropping soon."
  },
  {
    id: 2,
    username: "maya",
  ...
  return (
    <main className="instagram-app">
            ...
            <article className="post" key={post.id}>
              ...
              <div className="post-actions">
                ...
                <div>
                  ...
                  <button
                    className={isLiked ? "action liked" : "action"}
      ...
      <nav className="mobile-nav">
        <a href="/"><Home size={23} /></a>
        <a href="/explore"><Search size={23} /></a>
        <button><Plus size={25} /></button>
        <a href="/login"><Video size={23} /></a>
        <a href="/profile"><User size={23} /></a>
      </nav>
